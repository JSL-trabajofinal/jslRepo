...
@javax.jdo.annotations.Unique(name="Usuario_lastName_firstName_UNQ", members = {"lastName", "firstName"})
@DomainObject(auditing = Auditing.ENABLED)
@DomainObjectLayout()  // causes UI events to be triggered
public class Usuario implements Comparable<Usuario> {

    public Usuario(final String lastName, final String firstName) {
   ...
   // @Property(hidden = Where.EVERYWHERE)
    ...
    public static class PhoneNumberSpec extends AbstractSpecification<String> {
        ...
        public String satisfiesSafely(final String phoneNumber) {
            ...
            return matcher.matches() ? null :
                    "Especificar solo, es opcional el prefijo con '+'.  " +
                    "Por ejemplo, '+353 1 555 1234', o '07123 456789'";
        }
    }
    ...
    public String validateEmailAddress(String emailAddress) {
        return emailAddress.contains("@") ? null : "Email debe contener una '@'";
    }
    ...
    @Action(
            ...
            associateWith = "reclamos"
    )
    public Reclamo newReclamo(final String name, final TipoDeReclamo tipoDeReclamo) {
        return repositoryService.persist(new Reclamo(this, name, tipoDeReclamo));
    }

    @Action(
            semantics = SemanticsOf.NON_IDEMPOTENT,
            associateWith = "reclamos", associateWithSequence = "2"
    )
    public Usuario removeReclamo(Reclamo reclamo) {
        repositoryService.removeAndFlush(reclamo);
        return this;
    }
