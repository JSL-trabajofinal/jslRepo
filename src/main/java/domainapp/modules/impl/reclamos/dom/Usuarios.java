...
public class Usuarios {
    ...
    public Usuario create(
            ...
            @Parameter(
                    mustSatisfy = Usuario.PhoneNumberSpec.class,
                    maxLength = 15,
                    optionality = Optionality.OPTIONAL
            )
            final String phoneNumber) {
        Usuario usuario = new Usuario(lastName, firstName);
        usuario.setPhoneNumber(phoneNumber);
        return repositoryService.persist(usuario);
    }
