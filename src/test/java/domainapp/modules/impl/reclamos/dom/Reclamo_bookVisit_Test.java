...
public class Reclamo_bookVisit_Test {
    ...
    public void default0BookVisit() {
        ...
        // given
        Reclamo reclamo = new Reclamo(null, null, null);
        reclamo.clockService = mockClockService;
        ...
        // when
        LocalDateTime actual = reclamo.default0BookVisit();
