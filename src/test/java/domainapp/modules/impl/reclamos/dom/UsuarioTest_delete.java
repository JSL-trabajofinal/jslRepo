...
public class UsuarioTest_delete {
    ...
    public void happy_case() throws Exception {
        ...
        // given
        final Usuario object = new Usuario("Parker", "Peter");
        ...
        context.checking(new Expectations() {{
            allowing(mockTitleService).titleOf(object); will(returnValue("Parker, P"));

            oneOf(mockMessageService).informUser(with(containsString("'Parker, P' deleted")));
